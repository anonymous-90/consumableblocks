...
public class ModItems {
    ...
    public static final Item EdibleIce = registerItems("edible_ice",properties -> new EdibleIce(properties
            .food(ModFoodItems.superAwesomeStickFood,ModFoodItems.superAwesomeStickConsumable)
            .stacksTo(1)));
