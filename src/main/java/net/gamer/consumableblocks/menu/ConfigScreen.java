...
//        Ice.setTooltip(Tooltip.create(IceTooltip));
    ...
    public void extractRenderState(@NonNull GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
        super.extractRenderState(graphics, mouseX, mouseY, delta);
            if(this.isMouseOver(this.minecraft.getWindow().getGuiScaledWidth()-this.width+150, 80 - this.font.lineHeight)){
            graphics.text(this.font,Component.literal("i am awsome"),5,5, 0xFFFFFFFF );

            }
            this.minecraft.player.sendSystemMessage(Component.literal("mouseX:" + this.minecraft.mouseHandler.getScaledXPos(this.minecraft.getWindow())).append("MouseY:" + this.minecraft.mouseHandler.getScaledYPos(this.minecraft.getWindow())));
