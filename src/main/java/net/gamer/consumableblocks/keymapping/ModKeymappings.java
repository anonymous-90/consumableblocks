...
public class ModKeymappings {
    ...
    public static final KeyMapping SmeltItem = new KeyMapping("key.consumable_blocks_key", InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_B, KeyMapping.Category.GAMEPLAY);
